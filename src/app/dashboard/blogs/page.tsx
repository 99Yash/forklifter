...
export const metadata: Metadata = {
  title: "Blogs",
  description: `Add links to published articles or media.`,
};
      ...
      <div className="flex justify-between">
        <div className="flex flex-col">
          ...
          <p className="text-muted-foreground">
            Add links to published articles or media.
          </p>
        </div>
        <AddBlog />
      </div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 text-center">
            <h2 className="text-2xl font-bold">
              <Balancer>You currently have no writings.</Balancer>
            </h2>
            <p className="text-md text-muted-foreground">
              <Balancer>
                Writing is a great way to share thoughts & experiences with the
                world. If you have any published articles or media, add them
                here.
              </Balancer>
            </p>
          </div>
